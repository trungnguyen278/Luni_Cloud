/* ============================================================
   ...
   Ported from lib/luni-icons.jsx.
   ============================================================ */
import type { CSSProperties } from 'react';

export const LUNI_ICON_PATHS: Record<string, string> = {
  // nav / chrome
...
export function Icon({ name, size = 20, color = 'currentColor', strokeWidth = 1.7, style }: IconProps) {
